package com.nayottama.catatanpenjualansederhana.network

import com.nayottama.catatanpenjualansederhana.activity.data_barang.data.ResultDataBarang
import com.nayottama.catatanpenjualansederhana.activity.login.data.ResultLogin
import com.nayottama.catatanpenjualansederhana.activity.penjualan.data.ResultKeranjang
import com.nayottama.catatanpenjualansederhana.activity.penjualan.data.ResultSearchBarang
...
interface CatatanPenjualanService {
    ...
    fun getItemKeranjang(@Field("id_user") id_user: Int?,
                         @Field("id_keranjang") id_keranjang : Int?) : Call<ResultKeranjang>
